...
# url values, and read it using the .read() method. The assign the values to var 'html'.
soup = BeautifulSoup(html, "html.parser")   # Using the 'BeautifulSoup()' func, parse
# in the two arguments of var 'html' and 'html.parser' option, and assign to var 'soup'.
# The option 'html.parser' sort of cleans up the html.
