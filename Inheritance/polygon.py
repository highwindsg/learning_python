...
class Polygon:          # Create supperclass named Polygon.
    ...
    # separate new public funcs in the superclass to get the values of the private member vars.
    def get_width(self):        # Create get_width() func with param self.
        return self.__width     # Return the private value of __width from self.
    def get_height(self):       # Create the get_height() func with param self.
        return self.__height    # Return the private value of __height from self.
