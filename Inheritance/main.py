...
rect.set_values(50, 40)     # From rect var obj, set the attrib of .set_values with params 50 and 40)
tri.set_values(50, 40)      # From tri var obj, set the attrib of .set_values with params 50 and 40)

"""
Because the triangle.py and rectangle.py inherited the super class of shape.py,
the .set_color() and .get_color() funcs can also be called here.
"""

rect.set_color("red")       # Set the .set_color attrib of var rect to red.
tri.set_color("blue")       # Set the .set_color attrib of var tri to blue.
...
# Because there are no integer output, so no need to explicitly format as strings.
