...
"""
Fill in the blanks to make the factorial function return the factorial of n. Then, print the 
...
"""
Write a script that prints the first 10 cube numbers (x**3), starting with x=1 and ending 
with x=10.
